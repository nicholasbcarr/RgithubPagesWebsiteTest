...
#set directory for practice 1 (Papaya)
setwd("C:/Users/nickc/Desktop/Github/nickc/rPractice")
...
###My histogram of Total Soluable Solids
TSS<-Phen$TOTAL.SOLUBLE.SOLIDS
hist(TSS, col = "green")
```
...
## My ggPlot
ggplot(Phen, aes(FRUIT.LENGTH, SEED.CAVITY.WIDTH, group=FRUIT.FLESH.COLOR, col=FRUIT.FLESH.COLOR)) + 
         geom_point() +
